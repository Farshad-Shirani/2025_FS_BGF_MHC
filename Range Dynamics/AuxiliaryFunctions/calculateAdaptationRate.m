function [random,  optimal] = calculateAdaptationRate(solution, variableLocation, modelParameters, discretizationParamaters )
%--- This function is essentially the same as construct_F1. But it just returns the two components of F1 associated
%--- with random and optimal dispersal separaterly. F1 is the sum of the two components. 
