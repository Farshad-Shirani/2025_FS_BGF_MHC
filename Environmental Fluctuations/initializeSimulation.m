...
T = 500; %final time
storageTimes = 0 : 0.4 : T; % solution storage times. Solutins are stored at closest time samples depending on Dt
...
A_max1 = 2 * ones(I, 1); % maximum velocity adjustment for optimal advective dispersal for population 1
